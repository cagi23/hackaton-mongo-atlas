...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    ConnectionString mongoUri = new ConnectionString("mongodb+srv://cagisw:cagisw@hackatoncluster.pvtu697.mongodb.net/?retryWrites=true&w=majority");

    // Provide the name of the database and collection you want to use.
    // If they don't already exist, the driver and Atlas will create them
    // automatically when you first write data.
    String dbName = "storia";
    String collectionName = "eventi_storici";
